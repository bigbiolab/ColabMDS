...
|--------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| Lab.00 ![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg) | Installing Software on Google Colab for IBM3202 tutorials (**OBSOLETE**)                           | pyRosetta [1], GROMACS [2], SBM-enhanced GROMACS [3]                                                        |
